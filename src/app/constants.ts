...
export const roofingTitle = "Roofing Replacements and Repairs"
export const roofingDescription = "We specialize in providing durable roofing solutions with expert installation and " +
...
{/* Home Page Constants */}
export const homePageTitle = "Allstar Roofing and Fencing"

export const homePageDescription = "At Allstar Roofing and Fencing, our mission is to provide dependable roof and fence installation and repair\n" +
...
export const homePageRoofingTitle = "ROOFING"
export const homePageRoofingDescription = "We specialize in providing durable roofing solutions" +
...
export const homePageFencingTitle = "FENCING"
export const homePageFencingDescription = "We provide high-quality, durable, and stylish fencing solutions tailored to your needs. " +
...
export const homePageServiceAreaTitle = "Service Area"
export const homePageServiceAreaDescription = "Our extensive reach means we're always " +
